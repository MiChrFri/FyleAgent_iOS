...
class UnlockHiddenFolderView: UIView {
    ...
    private func setupLayout() {
        NSLayoutConstraint.activate([
            ...
            doneButton.leadingAnchor.constraint(equalTo: passcodeView.leadingAnchor, constant: 16.0),
            doneButton.trailingAnchor.constraint(equalTo: passcodeView.trailingAnchor, constant: -16.0),
